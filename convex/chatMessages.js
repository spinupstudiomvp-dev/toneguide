...
exports.createSession = exports.send = exports.list = void 0;
var server_1 = require("./_generated/server");
var values_1 = require("convex/values");
exports.list = (0, server_1.query)({
    args: { sessionId: values_1.v.id("chatSessions") },
...
exports.send = (0, server_1.mutation)({
    ...
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db.insert("chatMessages", __assign(__assign({}, args), { createdAt: Date.now() }))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); },
...
exports.createSession = (0, server_1.mutation)({
    ...
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db.insert("chatSessions", __assign(__assign({}, args), { createdAt: Date.now() }))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); },
