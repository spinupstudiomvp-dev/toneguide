...
exports.list = (0, server_1.query)({
    args: { brandId: values_1.v.id("brands") },
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db
                        .query("checks")
                        .withIndex("by_brand", function (q) { return q.eq("brandId", args.brandId); })
                        .order("desc")
                        .take(50)];
...
exports.create = (0, server_1.mutation)({
    args: {
        ...
        feedback: values_1.v.string(),
        annotations: values_1.v.string(),
    },
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db.insert("checks", __assign(__assign({}, args), { createdAt: Date.now() }))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); },
