...
exports.list = exports.getByUrl = exports.get = exports.create = void 0;
...
exports.create = (0, server_1.mutation)({
    ...
    handler: function (ctx, args) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ctx.db.insert("toneAudits", __assign(__assign({}, args), { createdAt: Date.now() }))];
...
exports.get = (0, server_1.query)({
    args: { id: values_1.v.id("toneAudits") },
    handler: function (ctx_1, _a) { return __awaiter(void 0, [ctx_1, _a], void 0, function (ctx, _b) {
        var id = _b.id;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, ctx.db.get(id)];
                case 1: return [2 /*return*/, _c.sent()];
            }
        });
    }); },
});
exports.getByUrl = (0, server_1.query)({
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, ctx.db
                        .query("toneAudits")
                        .withIndex("by_url", function (q) { return q.eq("url", url); })
                        .order("desc")
                        .first()];
                case 1: return [2 /*return*/, _c.sent()];
            }
